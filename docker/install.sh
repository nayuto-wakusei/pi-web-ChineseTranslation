...
Options:
  ...
  --pi-web-version VER    npm @chainingintention/pi-web-cn version pin (default: latest)
...
asset_base=${PI_WEB_DOCKER_ASSET_BASE:-https://raw.githubusercontent.com/nayuto-wakusei/pi-web-ChineseTranslation/$asset_ref/docker}
