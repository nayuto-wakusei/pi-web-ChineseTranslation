...
export function createPiSessionManagerGateway(options: PiSessionManagerGatewayOptions): PiSessionManagerGateway & Required<Pick<PiSessionManagerGateway, "resolveSessionFile" | "invalidateSessionFile" | "listAll">> {
