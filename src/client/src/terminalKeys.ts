...
export const TERMINAL_SOFT_KEYS: readonly TerminalSoftKeyDefinition[] = [
  { id: "escape", label: "Esc", ariaLabel: "Escape", title: "发送 Escape" },
  { id: "tab", label: "Tab", ariaLabel: "Tab", title: "发送 Tab" },
  { id: "ctrl-c", label: "Ctrl+C", ariaLabel: "Control C", title: "中断前台进程" },
  { id: "ctrl-d", label: "Ctrl+D", ariaLabel: "Control D", title: "发送 EOF / 关闭输入" },
  { id: "ctrl-z", label: "Ctrl+Z", ariaLabel: "Control Z", title: "挂起前台进程" },
  { id: "ctrl-l", label: "Ctrl+L", ariaLabel: "Control L", title: "清屏 / 重绘终端" },
  { id: "ctrl-r", label: "Ctrl+R", ariaLabel: "Control R", title: "反向搜索历史" },
  { id: "ctrl-u", label: "Ctrl+U", ariaLabel: "Control U", title: "删除到行首" },
  { id: "ctrl-w", label: "Ctrl+W", ariaLabel: "Control W", title: "删除上一个单词" },
  ...
  { id: "home", label: "Home", ariaLabel: "Home", title: "移动到开头" },
  { id: "end", label: "End", ariaLabel: "End", title: "移动到末尾" },
  { id: "page-up", label: "PgUp", ariaLabel: "向上翻页", title: "向上翻页" },
  { id: "page-down", label: "PgDn", ariaLabel: "向下翻页", title: "向下翻页" },
  { id: "delete", label: "Del", ariaLabel: "Delete", title: "向前删除" },
  { id: "backspace", label: "⌫", ariaLabel: "Backspace", title: "退格" },
